...
pub struct StreetFeatureFacts {
    ...
    pub starter_hand_class: Option<String>,
    pub best_hand_class: Option<String>,
    pub best_hand_rank_value: Option<i64>,
    pub made_hand_category: Option<String>,
    pub draw_category: Option<String>,
    pub overcards_count: Option<i32>,
    pub has_air: Option<bool>,
    pub missed_flush_draw: Option<bool>,
    pub missed_straight_draw: Option<bool>,
