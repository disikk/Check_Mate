...
WHERE (target_kind = 'feature' AND target_version = 'mbr_runtime_v1' AND target_key IN (
   ...
   OR (target_kind = 'stat' AND target_key IN (
           'total_ko',
...
VALUES
    ...
    ('has_ko_attempt', 'mbr_runtime_v1', 'bool', 'bool', 'exact', 'Whether Hero records at least one canonical KO attempt on the hand from derived.hand_ko_attempts.'),
    ('has_ko_opportunity', 'mbr_runtime_v1', 'bool', 'bool', 'exact', 'Whether Hero records at least one canonical KO opportunity on the hand from derived.hand_ko_opportunities.'),
    ...
    ('hero_ko_attempt_count', 'mbr_runtime_v1', 'num', 'double', 'exact', 'Canonical KO attempt count attributed to Hero on the hand.'),
    ('hero_ko_opportunity_count', 'mbr_runtime_v1', 'num', 'double', 'exact', 'Canonical KO opportunity count attributed to Hero on the hand.'),
...
VALUES
    ...
    ('avg_ko_attempts_per_ft', 'canonical_query_time', 'exact', 'double', 'Average exact KO attempts per FT-reached tournament across the whole exact FT.'),
    ...
    ('ft_stack_conversion', 'canonical_query_time', 'exact', 'double', 'Exact whole-FT KO share divided by expected FT KO share from Hero FT-entry stack share.'),
    ('ft_stack_conversion_3_4', 'canonical_query_time', 'exact', 'double', 'Exact stage 3-4 KO share divided by expected stage 3-4 KO share from Hero stage-entry stack share.'),
    ('ft_stack_conversion_5_6', 'canonical_query_time', 'exact', 'double', 'Exact stage 5-6 KO share divided by expected stage 5-6 KO share from Hero stage-entry stack share.'),
    ('ft_stack_conversion_7_9', 'canonical_query_time', 'exact', 'double', 'Exact stage 7-9 KO share divided by expected stage 7-9 KO share from Hero stage-entry stack share.'),
    ...
    ('ft_ko_success_rate', 'canonical_query_time', 'exact', 'double', 'Exact whole-FT KO share divided by exact whole-FT KO attempt count.'),
    ...
    ('ko_attempts_per_ft_3_4', 'canonical_query_time', 'exact', 'double', 'Average exact KO attempts per tournament that reaches exact stage 3-4.'),
    ('ko_attempts_per_ft_5_6', 'canonical_query_time', 'exact', 'double', 'Average exact KO attempts per tournament that reaches exact stage 5-6.'),
    ('ko_attempts_per_ft_7_9', 'canonical_query_time', 'exact', 'double', 'Average exact KO attempts per tournament that reaches exact stage 7-9.'),
    ('ko_success_rate_3_4', 'canonical_query_time', 'exact', 'double', 'Exact stage 3-4 KO share divided by exact stage 3-4 KO attempt count.'),
    ('ko_success_rate_5_6', 'canonical_query_time', 'exact', 'double', 'Exact stage 5-6 KO share divided by exact stage 5-6 KO attempt count.'),
    ('ko_success_rate_7_9', 'canonical_query_time', 'exact', 'double', 'Exact stage 7-9 KO share divided by exact stage 7-9 KO attempt count.'),
    ('pre_ft_chips', 'canonical_query_time', 'exact', 'double', 'Legacy rush-stage chip output metric: average FT-entry stack over HH-covered tournaments minus 1000 start chips.'),
    ('pre_ft_ko', 'canonical_query_time', 'estimated', 'double', 'Weighted transition-hand KO share estimate on the single rush-to-FT hand immediately before the first exact FT hand.'),
    ('pre_ft_attempts', 'canonical_query_time', 'estimated', 'double', 'Weighted transition-hand KO attempt estimate on the single rush-to-FT hand immediately before the first exact FT hand.'),
...
VALUES
    ...
    ('ft_stack_conversion', 'feature', 'derived.mbr_stage_resolution.is_ft_hand', 'exact_core'),
    ...
    ('ft_stack_conversion', 'feature', 'derived.mbr_tournament_ft_helper.hero_ft_entry_stack_chips', 'exact_core'),
    ('ft_stack_conversion', 'feature', 'derived.mbr_tournament_ft_helper.first_ft_table_size_exact', 'exact_core'),
    ...
    ('ko_attempts_per_ft_3_4', 'feature', 'derived.mbr_stage_resolution.is_stage_3_4', 'exact_core'),
    ('ko_attempts_per_ft_3_4', 'feature', 'derived.hand_ko_attempts', 'exact_core'),
    ('ko_attempts_per_ft_3_4', 'coverage_metric', 'stage_3_4_tournament_count', ''),
    ('ko_attempts_per_ft_5_6', 'feature', 'derived.mbr_stage_resolution.is_stage_5_6', 'exact_core'),
    ('ko_attempts_per_ft_5_6', 'feature', 'derived.hand_ko_attempts', 'exact_core'),
    ('ko_attempts_per_ft_5_6', 'coverage_metric', 'stage_5_6_tournament_count', ''),
    ('ko_attempts_per_ft_7_9', 'feature', 'derived.mbr_stage_resolution.ft_players_remaining_exact', 'exact_core'),
    ('ko_attempts_per_ft_7_9', 'feature', 'derived.hand_ko_attempts', 'exact_core'),
    ('ko_attempts_per_ft_7_9', 'coverage_metric', 'stage_7_9_tournament_count', ''),
    ('ft_ko_success_rate', 'feature', 'derived.mbr_stage_resolution.is_ft_hand', 'exact_core'),
    ('ft_ko_success_rate', 'feature', 'derived.hand_eliminations.hero_involved', 'exact_core'),
    ('ft_ko_success_rate', 'feature', 'derived.hand_eliminations.certainty_state', 'exact_core'),
    ('ft_ko_success_rate', 'feature', 'derived.hand_ko_attempts', 'exact_core'),
    ('ko_success_rate_3_4', 'feature', 'derived.mbr_stage_resolution.is_stage_3_4', 'exact_core'),
    ('ko_success_rate_3_4', 'feature', 'derived.hand_eliminations.hero_involved', 'exact_core'),
    ('ko_success_rate_3_4', 'feature', 'derived.hand_eliminations.certainty_state', 'exact_core'),
    ('ko_success_rate_3_4', 'feature', 'derived.hand_ko_attempts', 'exact_core'),
    ('ko_success_rate_5_6', 'feature', 'derived.mbr_stage_resolution.is_stage_5_6', 'exact_core'),
    ('ko_success_rate_5_6', 'feature', 'derived.hand_eliminations.hero_involved', 'exact_core'),
    ('ko_success_rate_5_6', 'feature', 'derived.hand_eliminations.certainty_state', 'exact_core'),
    ('ko_success_rate_5_6', 'feature', 'derived.hand_ko_attempts', 'exact_core'),
    ('ko_success_rate_7_9', 'feature', 'derived.mbr_stage_resolution.ft_players_remaining_exact', 'exact_core'),
    ('ko_success_rate_7_9', 'feature', 'derived.hand_eliminations.hero_involved', 'exact_core'),
    ('ko_success_rate_7_9', 'feature', 'derived.hand_eliminations.certainty_state', 'exact_core'),
    ('ko_success_rate_7_9', 'feature', 'derived.hand_ko_attempts', 'exact_core'),
    ...
    ('pre_ft_chips', 'feature', 'derived.hand_state_resolutions.final_stacks', 'exact_core'),
    ('pre_ft_chips', 'feature', 'derived.mbr_tournament_ft_helper.first_ft_hand_started_local', 'exact_core'),
    ('pre_ft_chips', 'feature', 'derived.mbr_tournament_ft_helper.boundary_resolution_state', 'exact_core'),
    ('pre_ft_chips', 'feature', 'derived.mbr_stage_resolution.is_boundary_hand', 'exact_core'),
    ('pre_ft_chips', 'coverage_metric', 'pre_ft_supported_tournament_count', ''),
    ('pre_ft_ko', 'feature', 'derived.hand_eliminations.hero_involved', 'exact_core'),
    ('pre_ft_ko', 'feature', 'derived.hand_eliminations.certainty_state', 'exact_core'),
    ('pre_ft_ko', 'feature', 'derived.mbr_tournament_ft_helper.first_ft_hand_started_local', 'exact_core'),
    ('pre_ft_ko', 'feature', 'derived.mbr_stage_resolution.is_boundary_hand', 'exact_core'),
    ('pre_ft_attempts', 'feature', 'derived.hand_ko_attempts', 'exact_core'),
    ('pre_ft_attempts', 'feature', 'derived.mbr_tournament_ft_helper.first_ft_hand_started_local', 'exact_core'),
    ('pre_ft_attempts', 'feature', 'derived.mbr_stage_resolution.is_boundary_hand', 'exact_core'),
    ...
    ('avg_ko_attempts_per_ft', 'feature', 'derived.mbr_stage_resolution.is_ft_hand', 'exact_core'),
    ('avg_ko_attempts_per_ft', 'feature', 'derived.hand_ko_attempts', 'exact_core'),
...
VALUES
    ...
    ('feature', 'has_ko_attempt', 'mbr_runtime_v1', 'import_local_full_refresh', 'full_refresh'),
    ('feature', 'has_ko_opportunity', 'mbr_runtime_v1', 'import_local_full_refresh', 'full_refresh'),
    ...
    ('feature', 'hero_ko_attempt_count', 'mbr_runtime_v1', 'import_local_full_refresh', 'full_refresh'),
    ('feature', 'hero_ko_opportunity_count', 'mbr_runtime_v1', 'import_local_full_refresh', 'full_refresh'),
    ...
    ('stat', 'ft_ko_success_rate', '', 'query_only_canonical_snapshot', 'full_refresh'),
    ...
    ('stat', 'ko_attempts_per_ft_3_4', '', 'query_only_canonical_snapshot', 'full_refresh'),
    ('stat', 'ko_attempts_per_ft_5_6', '', 'query_only_canonical_snapshot', 'full_refresh'),
    ('stat', 'ko_attempts_per_ft_7_9', '', 'query_only_canonical_snapshot', 'full_refresh'),
    ('stat', 'ko_success_rate_3_4', '', 'query_only_canonical_snapshot', 'full_refresh'),
    ('stat', 'ko_success_rate_5_6', '', 'query_only_canonical_snapshot', 'full_refresh'),
    ('stat', 'ko_success_rate_7_9', '', 'query_only_canonical_snapshot', 'full_refresh'),
    ('stat', 'pre_ft_chips', '', 'query_only_canonical_snapshot', 'full_refresh'),
    ('stat', 'pre_ft_ko', '', 'query_only_canonical_snapshot', 'full_refresh'),
    ('stat', 'pre_ft_attempts', '', 'query_only_canonical_snapshot', 'full_refresh'),
